...
if __name__ == "__main__":
    ...
    #Other systems are not supported yet. Force to weighted avg to prevent crashes for now
    op = Op.WEIGHTEDAVG 

    #I should probably pull this all into another func, so people can scroll directly to the bottom. Too lazy though.
    filename = ""
    if jp:
        filename = "apd_jp.csv"
    else:
